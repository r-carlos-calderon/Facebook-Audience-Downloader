    ...
    if num_results != 0:
        ...
        while True:  # GET NEXT PAGE RESULTS (GRAPH API ENDPOINT) REF: https://thd.co/2WiLrf2
            try:
                ...
                sys.stdout.write(f'{t1}, {log_string}, FETCHING, {num_results}\n')  # OUTPUT FOR LOG FILE
                log.write(f'{t1}, {log_string}, FETCHING, {num_results}\n')  # SCREEN OUTPUT FOR TROUBLESHOOTING
            except KeyError:
                # WHEN THERE ARE NO MORE PAGES (['paging']['next']), BREAK THE LOOP
                break
        t2 = datetime.datetime.now()
        sys.stdout.write(f'{t2}, {log_string}, DOWNLOADED, {num_results}\n')  # OUTPUT FOR LOG FILE
        log.write(f'{t2}, {log_string}, DOWNLOADED, {num_results}\n')  # SCREEN OUTPUT FOR TROUBLESHOOTING
...
sys.stdout.write(f'{t3}, {business_account}, ALL, ALL, DOWNLOADED, {total_count}\n')  # OUTPUT FOR LOG FILE
log.write(f'{t3}, {business_account}, ALL, ALL, DOWNLOADED, {total_count}\n')  # SCREEN OUTPUT FOR TROUBLESHOOTING
sys.stdout.close()
